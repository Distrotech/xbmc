...
"If known prehand, this can (but does not have to) avoid HEAD requests being sent to HTTP servers to figure out file type.\n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_ListItem_setContentLookup__doc__,
...
"    - listitem.setSubtitles(['special://temp/example.srt', 'http://example.com/example.srt' ]) \n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_ListItem_getVideoInfoTag__doc__,
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_ListItem_getMusicInfoTag__doc__,
...
"    - self.fadelabel.addLabel('This is a line of text that can scroll.') \n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_ControlFadeLabel_setScrolling__doc__,
...
"    - self.textbox.scroll(10) \n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_ControlTextBox_autoScroll__doc__,
...
"    - ret = dialog.select('Choose a playlist', ['Playlist #1', 'Playlist #2, 'Playlist #3'])n\n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_Dialog_multiselect__doc__,
               "multiselect(heading, list [,autoclose]) -- Show a multi-select dialog.\n"
"\n"
"heading : string or unicode - dialog heading. options : list of string - options to choose from. autoclose : [opt] integer - milliseconds to autoclose dialog. (default=do not autoclose)\n"
"\n"
...
"    - ok = dialog.ok('XBMC', 'There was an error.')n\n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcgui_Dialog_textviewer__doc__,
...
"\n"
"Note, if your script ends this window will be closed to. To show it forever, make a loop at the end of your script ar use doModal()  instead \n");
...
"\n"
"Note, not python controls are not completely usable yet You can only use the Control  functions \n");
...
"    - self.setProperty('Category', 'Newest') \n");
  ...
  static PyMethodDef XBMCAddon_xbmcgui_ListItem_methods[] = { 
    ...
    {(char*)"setContentLookup", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_ListItem_setContentLookup, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_ListItem_setContentLookup__doc__ }, 
    ...
    {(char*)"getVideoInfoTag", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_ListItem_getVideoInfoTag, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_ListItem_getVideoInfoTag__doc__ }, 
    {(char*)"getMusicInfoTag", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_ListItem_getMusicInfoTag, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_ListItem_getMusicInfoTag__doc__ }, 
    {NULL, NULL, 0, NULL}
  };
  ...
  static void initPyXBMCAddon_xbmcgui_ListItem_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcgui_ListItem__doc__,
                 "ListItem([label, label2, iconImage, thumbnailImage, path])\n"
"\n"
"\n"
"label : [opt] string label2 : [opt] string iconImage : Deprecated. Use setArt thumbnailImage : Deprecated. Use setArt path : [opt] string \n"
                );
    ...
    pythonType.tp_doc = XBMCAddon_xbmcgui_ListItem__doc__;
...
"    - self.cList = xbmcgui.ControlList (100, 250, 200, 250, 'font14', space=5) \n"
  ...
  static PyMethodDef XBMCAddon_xbmcgui_ControlFadeLabel_methods[] = { 
    ...
    {(char*)"setScrolling", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_ControlFadeLabel_setScrolling, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_ControlFadeLabel_setScrolling__doc__ }, 
...
"    - self.fadelabel = xbmcgui.ControlFadeLabel (100, 250, 200, 50, textColor='0xFFFFFFFF') \n"
  ...
  static PyMethodDef XBMCAddon_xbmcgui_ControlTextBox_methods[] = { 
    ...
    {(char*)"autoScroll", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_ControlTextBox_autoScroll, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_ControlTextBox_autoScroll__doc__ }, 
    {NULL, NULL, 0, NULL}
  };
...
"    - self.slider = xbmcgui.ControlSlider(100, 250, 350, 40) \n"
  ...
  static PyMethodDef XBMCAddon_xbmcgui_Dialog_methods[] = { 
    ...
    {(char*)"multiselect", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_Dialog_multiselect, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_Dialog_multiselect__doc__ }, 
    {(char*)"ok", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_Dialog_ok, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_Dialog_ok__doc__ }, 
    {(char*)"textviewer", (PyCFunction)xbmcgui_XBMCAddon_xbmcgui_Dialog_textviewer, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcgui_Dialog_textviewer__doc__ }, 
...
"    - del ui \n"
  ...
  void initModule_xbmcgui()
  {
   ...
   PyModule_AddStringConstant(module, (char*)"__date__", (char*)"Sun May 01 15:09:22 SAST 2016");
