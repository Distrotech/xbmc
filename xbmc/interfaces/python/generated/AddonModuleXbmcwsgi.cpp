...
namespace PythonBindings
{
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiErrorStream_flush__doc__,
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiErrorStream_write__doc__,
...
" is removed. \n");
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiErrorStream_writelines__doc__,
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_read__doc__,
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_readline__doc__,
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_readlines__doc__,
  ...
  static PyMethodDef XBMCAddon_xbmcwsgi_WsgiErrorStream_methods[] = { 
    {(char*)"flush", (PyCFunction)xbmcwsgi_XBMCAddon_xbmcwsgi_WsgiErrorStream_flush, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcwsgi_WsgiErrorStream_flush__doc__ }, 
    {(char*)"write", (PyCFunction)xbmcwsgi_XBMCAddon_xbmcwsgi_WsgiErrorStream_write, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcwsgi_WsgiErrorStream_write__doc__ }, 
    {(char*)"writelines", (PyCFunction)xbmcwsgi_XBMCAddon_xbmcwsgi_WsgiErrorStream_writelines, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcwsgi_WsgiErrorStream_writelines__doc__ }, 
    {NULL, NULL, 0, NULL}
  };
  ...
  static void initPyXBMCAddon_xbmcwsgi_WsgiErrorStream_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiErrorStream__doc__,
...
"This implementation writes the error messages to the application's log file. \n"
    ...
    pythonType.tp_doc = XBMCAddon_xbmcwsgi_WsgiErrorStream__doc__;
  ...
  static PyMethodDef XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_methods[] = { 
    {(char*)"read", (PyCFunction)xbmcwsgi_XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_read, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_read__doc__ }, 
    {(char*)"readline", (PyCFunction)xbmcwsgi_XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_readline, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_readline__doc__ }, 
    {(char*)"readlines", (PyCFunction)xbmcwsgi_XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_readlines, METH_VARARGS|METH_KEYWORDS, XBMCAddon_xbmcwsgi_WsgiInputStreamIterator_readlines__doc__ }, 
    {NULL, NULL, 0, NULL}
  };
  ...
  static void initPyXBMCAddon_xbmcwsgi_WsgiInputStreamIterator_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiInputStreamIterator__doc__,
    ...
    pythonType.tp_doc = XBMCAddon_xbmcwsgi_WsgiInputStreamIterator__doc__;
  ...
  static void initPyXBMCAddon_xbmcwsgi_WsgiInputStream_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiInputStream__doc__,
    ...
    pythonType.tp_doc = XBMCAddon_xbmcwsgi_WsgiInputStream__doc__;
  ...
  static void initPyXBMCAddon_xbmcwsgi_WsgiResponse_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiResponse__doc__,
    ...
    pythonType.tp_doc = XBMCAddon_xbmcwsgi_WsgiResponse__doc__;
  ...
  static void initPyXBMCAddon_xbmcwsgi_WsgiResponseBody_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcwsgi_WsgiResponseBody__doc__,
    ...
    pythonType.tp_doc = XBMCAddon_xbmcwsgi_WsgiResponseBody__doc__;
  ...
  void initModule_xbmcwsgi()
  {
   ...
   PyModule_AddStringConstant(module, (char*)"__date__", (char*)"Sun May 01 17:48:16 SAST 2016");
