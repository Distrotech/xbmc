...
"\n"
"\n"
"handle : integer - handle the plugin was started with. url : string - url of the entry. would be plugin:// for another virtual directory listitem : ListItem - item to add. isFolder : [opt] bool - True=folder / False=not a folder(default). totalItems : [opt] integer - total number of items that will be passed.(used for progressbar)\n"
"\n"
...
"\n"
"\n"
"handle : integer - handle the plugin was started with. items :List - list of (url, listitem[, isFolder]) as a tuple to add. totalItems : [opt] integer - total number of items that will be passed.(used for progressbar)Large lists benefit over using the standard addDirectoryItem()\n"
...
"    - if not xbmcplugin.addDirectoryItems(int(sys.argv[1]), [(url, listitem, False,)]: raise\n");
  ...
  static PyObject* xbmcplugin_addDirectoryItems (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    int  handle ;         
    std::vector< Tuple< String ,XBMCAddon::xbmcgui::ListItem const *,bool  >  >  items ;
...

    {
      ...
      for(int i = 0; i < vecSize; i++)
      {
        ...
        Tuple< String ,XBMCAddon::xbmcgui::ListItem const *,bool  >  entry1;
...
"\n"
"handle : integer - handle the plugin was started with. succeeded : [opt] bool - True=script completed successfully(Default)/False=Script did not. updateListing : [opt] bool - True=this folder should update the current listing/False=Folder is a subfolder(Default). cacheToDisc : [opt] bool - True=Folder will cache if extended time(default)/False=this folder will never cache to disc.\n"
"\n"
"example:\n"
...
"\n"
"handle : integer - handle the plugin was started with. succeeded : bool - True=script completed successfully/False=Script did not. listitem : ListItem - item the file plugin resolved to for playback.\n"
"\n"
"example:\n"
...
"\n"
"handle : integer - handle the plugin was started with. sortMethod : integer - number for sortmethod see FileItem.h. label2Mask : [opt] string - the label mask to use for the second label. Defaults to 'D' applies to: SORT_METHOD_NONE, SORT_METHOD_UNSORTED, SORT_METHOD_VIDEO_TITLE, SORT_METHOD_TRACKNUM, SORT_METHOD_FILE, SORT_METHOD_TITLE, SORT_METHOD_TITLE_IGNORE_THE, SORT_METHOD_LABEL, SORT_METHOD_LABEL_IGNORE_THE, SORT_METHOD_VIDEO_SORT_TITLE, SORT_METHOD_VIDEO_SORT_TITLE_IGNORE_THE\n"
"\n"
"example:\n"
...
"\n"
"handle : integer - handle the plugin was started with. id : string - id of the setting that the module needs to access.\n"
"\n"
...
"    - apikey = xbmcplugin.getSetting(int(sys.argv[1]), 'apikey')\n");
  ...
  static PyObject* xbmcplugin_getSetting (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      XBMCAddon::SetLanguageHookGuard slhg(XBMCAddon::Python::LanguageHook::GetIfExists(PyThreadState_Get()->interp).get());
      apiResult = (String )XBMCAddon::xbmcplugin::getSetting(  handle,  id  );
...
"\n"
"handle : integer - handle the plugin was started with. id : string - id of the setting that the module needs to access. value : string or unicode - value of the setting.\n"
"\n"
"example:\n"
...
"\n"
"handle : integer - handle the plugin was started with. content : string - content type (eg. movies)\n"
"\n"
...
"\n"
"handle : integer - handle the plugin was started with. category : string or unicode - plugins sub category.\n"
"\n"
"example:\n"
...
"\n"
"handle : integer - handle the plugin was started with. image : [opt] string - path to fanart image. color1 : [opt] hexstring - color1. (e.g. '0xFFFFFFFF') color2 : [opt] hexstring - color2. (e.g. '0xFFFF3300') color3 : [opt] hexstring - color3. (e.g. '0xFF000000')\n"
"\n"
"example:\n"
...
"\n"
"handle : integer - handle the plugin was started with. key : string - property name. value : string or unicode - value of property.\n"
"\n"
...
"    - xbmcplugin.setProperty(int(sys.argv[1]), 'Emulator', 'M.A.M.E.')\n");
  ...
  void initModule_xbmcplugin()
  {
   ...
   PyModule_AddStringConstant(module, (char*)"__date__", (char*)"Thu Mar 06 11:21:10 SAST 2014");
   ...
   PyModule_AddIntConstant(module,"SORT_METHOD_NONE",(int)SORT_METHOD_NONE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LABEL",(int)SORT_METHOD_LABEL); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LABEL_IGNORE_THE",(int)SORT_METHOD_LABEL_IGNORE_THE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DATE",(int)SORT_METHOD_DATE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_SIZE",(int)SORT_METHOD_SIZE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_FILE",(int)SORT_METHOD_FILE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DRIVE_TYPE",(int)SORT_METHOD_DRIVE_TYPE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_TRACKNUM",(int)SORT_METHOD_TRACKNUM); 
   PyModule_AddIntConstant(module,"SORT_METHOD_DURATION",(int)SORT_METHOD_DURATION); 
   PyModule_AddIntConstant(module,"SORT_METHOD_TITLE",(int)SORT_METHOD_TITLE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_TITLE_IGNORE_THE",(int)SORT_METHOD_TITLE_IGNORE_THE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ARTIST",(int)SORT_METHOD_ARTIST); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ARTIST_IGNORE_THE",(int)SORT_METHOD_ARTIST_IGNORE_THE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ALBUM",(int)SORT_METHOD_ALBUM); 
   PyModule_AddIntConstant(module,"SORT_METHOD_ALBUM_IGNORE_THE",(int)SORT_METHOD_ALBUM_IGNORE_THE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_GENRE",(int)SORT_METHOD_GENRE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_YEAR",(int)SORT_METHOD_YEAR); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_RATING",(int)SORT_METHOD_VIDEO_RATING); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PROGRAM_COUNT",(int)SORT_METHOD_PROGRAM_COUNT); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PLAYLIST_ORDER",(int)SORT_METHOD_PLAYLIST_ORDER); 
   PyModule_AddIntConstant(module,"SORT_METHOD_EPISODE",(int)SORT_METHOD_EPISODE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_TITLE",(int)SORT_METHOD_VIDEO_TITLE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_SORT_TITLE",(int)SORT_METHOD_VIDEO_SORT_TITLE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_SORT_TITLE_IGNORE_THE",(int)SORT_METHOD_VIDEO_SORT_TITLE_IGNORE_THE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_PRODUCTIONCODE",(int)SORT_METHOD_PRODUCTIONCODE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_SONG_RATING",(int)SORT_METHOD_SONG_RATING); 
   PyModule_AddIntConstant(module,"SORT_METHOD_MPAA_RATING",(int)SORT_METHOD_MPAA_RATING); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_RUNTIME",(int)SORT_METHOD_VIDEO_RUNTIME); 
   PyModule_AddIntConstant(module,"SORT_METHOD_STUDIO",(int)SORT_METHOD_STUDIO); 
   PyModule_AddIntConstant(module,"SORT_METHOD_STUDIO_IGNORE_THE",(int)SORT_METHOD_STUDIO_IGNORE_THE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_UNSORTED",(int)SORT_METHOD_UNSORTED); 
   PyModule_AddIntConstant(module,"SORT_METHOD_BITRATE",(int)SORT_METHOD_BITRATE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_LISTENERS",(int)SORT_METHOD_LISTENERS); 
  }
