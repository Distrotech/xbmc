...
namespace PythonBindings
{
  ...
  PyTypeObject PyXBMCAddon_xbmcvfs_File_Type;
  TypeInfo TyXBMCAddon_xbmcvfs_File_Type;
  //=========================================================================

  //=========================================================================
  // These variables will hold the Python Type information for XBMCAddon::xbmcvfs::Stat
  PyTypeObject PyXBMCAddon_xbmcvfs_Stat_Type;
  TypeInfo TyXBMCAddon_xbmcvfs_Stat_Type;
  //=========================================================================
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_New (PyTypeObject* pytype  , PyObject *args, PyObject *kwds  )
  {
    ...
    result = makePythonInstance(apiResult,pytype,&TyXBMCAddon_xbmcvfs_File_Type,false);
...
"returns: string\n"
"\n"
"example: f = xbmcvfs.File(file) b = f.read() f.close()\n");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_read (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (String )((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"read","XBMCAddon::xbmcvfs::File"))-> read(  numBytes  );
...
"example: f = xbmcvfs.File(file) b = f.read() f.close()\n");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_readBytes (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (XbmcCommons::Buffer )((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"readBytes","XBMCAddon::xbmcvfs::File"))-> readBytes(  numBytes  );
...
"\n"
"example: f =xbmcvfs.File (file, 'w', True) result = f.write(buffer) f.close()\n");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_write (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    else if (PyByteArray_Check(pybuffer))
    {
      ...
      apiResult = (bool )((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"write","XBMCAddon::xbmcvfs::File"))-> write(  buffer  );
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcvfs_File_size__doc__,
               "size() \n"
"\n"
"example: f = xbmcvfs.File(file) s = f.size() f.close()\n");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_size (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"size","XBMCAddon::xbmcvfs::File"))-> size(  );
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcvfs_File_seek__doc__,
               "seek() \n"
"\n"
"FilePosition : position in the file Whence : where in a file to seek from[0 begining, 1 current , 2 end possition] example: f = xbmcvfs.File(file) result = f.seek(8129, 0) f.close()\n");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_seek (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"seek","XBMCAddon::xbmcvfs::File"))-> seek(  seekBytes,  iWhence  );
  ...
  PyDoc_STRVAR(XBMCAddon_xbmcvfs_File_close__doc__,
               "close() \n"
"\n"
"example: f = xbmcvfs.File(file) f.close()\n");
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_File_close (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      ((XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"close","XBMCAddon::xbmcvfs::File"))-> close(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_New (PyTypeObject* pytype  , PyObject *args, PyObject *kwds  )
  {
    ...
    // transform the result
    result = makePythonInstance(apiResult,pytype,&TyXBMCAddon_xbmcvfs_Stat_Type,false);
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_mode (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_mode","XBMCAddon::xbmcvfs::Stat"))-> st_mode(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_ino (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_ino","XBMCAddon::xbmcvfs::Stat"))-> st_ino(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_dev (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_dev","XBMCAddon::xbmcvfs::Stat"))-> st_dev(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_nlink (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_nlink","XBMCAddon::xbmcvfs::Stat"))-> st_nlink(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_uid (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_uid","XBMCAddon::xbmcvfs::Stat"))-> st_uid(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_gid (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_gid","XBMCAddon::xbmcvfs::Stat"))-> st_gid(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_size (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"st_size","XBMCAddon::xbmcvfs::Stat"))-> st_size(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_atime (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"atime","XBMCAddon::xbmcvfs::Stat"))-> atime(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_mtime (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"mtime","XBMCAddon::xbmcvfs::Stat"))-> mtime(  );
  ...
  static PyObject* xbmcvfs_XBMCAddon_xbmcvfs_Stat_st_ctime (PyHolder* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    try
    {
      ...
      apiResult = (long long )((XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"ctime","XBMCAddon::xbmcvfs::Stat"))-> ctime(  );
...
"\n"
"source : file to copy. destination : destination fi\n"
"\n"
"example: success = xbmcvfs.copy(source, destination)\n");
...
"\n"
"file : file to reana newFileName : new filename, including the full pa\n"
"\n"
"example: success = xbmcvfs.rename(file,newFileName)\n");
...
"\n"
"example: success = xbmcvfs.exists(path)\n");
...
"    - dirs, files = xbmcvfs.listdir(path)\n");
  ...
  static PyObject* xbmcvfs_listdir (PyObject* self  , PyObject *args, PyObject *kwds  )
  {
    ...
    Tuple< std::vector< String  > ,std::vector< String  >  >  apiResult;
    try
    {
      if (pypath) PyXBMCGetUnicodeString(path,pypath,false,"path","XBMCAddon::xbmcvfs::listdir"); 

      XBMCAddon::SetLanguageHookGuard slhg(XBMCAddon::Python::LanguageHook::GetIfExists(PyThreadState_Get()->interp).get());
      apiResult = (Tuple< std::vector< String  > ,std::vector< String  >  > )XBMCAddon::xbmcvfs::listdir(  path  );
    ...
    result = PyTuple_New(vecSize);
    {
      ...
      if (vecSize > 0)
      {
        std::vector< String  > & entry1 = apiResult.first();
        {
...
pyentry2 = PyString_FromStringAndSize(entry2.c_str(), entry2.length());
      ...
      if (vecSize > 1)
      {
        std::vector< String  > & entry1 = apiResult.second();
        {
...
pyentry3 = PyString_FromStringAndSize(entry3.c_str(), entry3.length());
  ...
  static void xbmcvfs_XBMCAddon_xbmcvfs_File_Dealloc (PyHolder* self  )
  {
    ...
    try
    {
      ...
      XBMCAddon::xbmcvfs::File* theObj = (XBMCAddon::xbmcvfs::File*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_File_Type,"~XBMCAddon::xbmcvfs::File","XBMCAddon::xbmcvfs::File");
  ...
  static void xbmcvfs_XBMCAddon_xbmcvfs_Stat_Dealloc (PyHolder* self  )
  {
    ...
    try
    {
      ...
      XBMCAddon::xbmcvfs::Stat* theObj = (XBMCAddon::xbmcvfs::Stat*)retrieveApiInstance((PyObject*)self,&PyXBMCAddon_xbmcvfs_Stat_Type,"~XBMCAddon::xbmcvfs::Stat","XBMCAddon::xbmcvfs::Stat");
      cleanForDealloc(theObj);
  ...
  static void initPyXBMCAddon_xbmcvfs_File_Type()
  {
    ...
    PyDoc_STRVAR(XBMCAddon_xbmcvfs_File__doc__,
                 "File class.\n"
"\n"
"'w' - opt open for write example: f =xbmcvfs.File (file, ['w'])\n"
                );

    PyXBMCInitializeTypeObject(&PyXBMCAddon_xbmcvfs_File_Type,&TyXBMCAddon_xbmcvfs_File_Type);

    PyXBMCAddon_xbmcvfs_File_Type.tp_name = (char*)"xbmcvfs.File";
    PyXBMCAddon_xbmcvfs_File_Type.tp_basicsize = sizeof(PyHolder);
    PyXBMCAddon_xbmcvfs_File_Type.tp_dealloc = (destructor)xbmcvfs_XBMCAddon_xbmcvfs_File_Dealloc; 

    PyXBMCAddon_xbmcvfs_File_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;
    PyXBMCAddon_xbmcvfs_File_Type.tp_doc = XBMCAddon_xbmcvfs_File__doc__;
    PyXBMCAddon_xbmcvfs_File_Type.tp_methods = XBMCAddon_xbmcvfs_File_methods;
    PyXBMCAddon_xbmcvfs_File_Type.tp_base = NULL;
    PyXBMCAddon_xbmcvfs_File_Type.tp_new = xbmcvfs_XBMCAddon_xbmcvfs_File_New;
...
"path : file or folder\n"
"\n"
"example: st = xbmcvfs.Stat(path) modified = st.st_mtime()\n"
                );

    PyXBMCInitializeTypeObject(&PyXBMCAddon_xbmcvfs_Stat_Type,&TyXBMCAddon_xbmcvfs_Stat_Type);

    PyXBMCAddon_xbmcvfs_Stat_Type.tp_name = (char*)"xbmcvfs.Stat";
    PyXBMCAddon_xbmcvfs_Stat_Type.tp_basicsize = sizeof(PyHolder);
    PyXBMCAddon_xbmcvfs_Stat_Type.tp_dealloc = (destructor)xbmcvfs_XBMCAddon_xbmcvfs_Stat_Dealloc; 

    PyXBMCAddon_xbmcvfs_Stat_Type.tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE;
    PyXBMCAddon_xbmcvfs_Stat_Type.tp_doc = XBMCAddon_xbmcvfs_Stat__doc__;
    PyXBMCAddon_xbmcvfs_Stat_Type.tp_methods = XBMCAddon_xbmcvfs_Stat_methods;
    PyXBMCAddon_xbmcvfs_Stat_Type.tp_base = NULL;
    PyXBMCAddon_xbmcvfs_Stat_Type.tp_new = xbmcvfs_XBMCAddon_xbmcvfs_Stat_New;
  ...
  static void initTypes()
  {
    ...
    if (!typesAlreadyInitialized)
    {
      ...
      if (PyType_Ready(&PyXBMCAddon_xbmcvfs_File_Type) < 0)
        return;
      if (PyType_Ready(&PyXBMCAddon_xbmcvfs_Stat_Type) < 0)
        return;
    }
  }
  ...
  void initModule_xbmcvfs()
  {
    ...
    Py_INCREF(&PyXBMCAddon_xbmcvfs_File_Type);
    Py_INCREF(&PyXBMCAddon_xbmcvfs_Stat_Type);

    module = Py_InitModule((char*)"xbmcvfs", xbmcvfs_methods);
    if (module == NULL) return;


    PyModule_AddObject(module, (char*)"File", (PyObject*)&PyXBMCAddon_xbmcvfs_File_Type);
    PyModule_AddObject(module, (char*)"Stat", (PyObject*)&PyXBMCAddon_xbmcvfs_Stat_Type);

   // constants
   PyModule_AddStringConstant(module, (char*)"__author__", (char*)"Team XBMC <www.xbmc.org>");
   PyModule_AddStringConstant(module, (char*)"__date__", (char*)"Thu Mar 06 11:21:18 SAST 2014");
